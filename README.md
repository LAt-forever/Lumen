...
Lumen 是一个本地优先的个人 AI 知识库和长期记忆助手。当前版本是 Phase 1.5 原型，重点是让核心知识闭环更适合日常使用：
...
- 左侧导航已能切换今天、提问、资料库、记忆、搜索、回顾、状态和设置视图。
...
- 图片知识库、图谱可视化、Agent 配置 UI、外部 reranker 配置和完整任务队列面板仍未实现。
