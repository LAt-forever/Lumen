...
Lumen 是一个本地优先的个人 AI 知识库和长期记忆助手。当前版本是 Phase 1.4 原型，重点是先跑通并收紧一个可用闭环：
...
- Phase 1.4 的模型配置仍只支持 OpenAI-compatible 聊天接口。
...
- 图片知识库、图谱可视化、标签、收藏和 Agent 配置 UI 仍未实现。
